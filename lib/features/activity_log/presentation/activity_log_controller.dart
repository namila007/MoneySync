...
/// Recovery actions the Activity page dispatches into, backed by the outbox
/// DAO so Retry/Verify move the real mutation row (M5.14 gap 5).
final activityRecoveryActionsProvider = FutureProvider<ActivityRecoveryActions>(
  (ref) async {
    final database = await ref.watch(appDatabaseProvider.future);
    return DriftActivityRecoveryActions(
